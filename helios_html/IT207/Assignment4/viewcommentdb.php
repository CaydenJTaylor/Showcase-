...
if($conn) 
{
 ...
 if($rows>0)
 {
    ...
    echo "<p><a href ='database.html'>Add New Contact</a></p>";
 	echo "<p><a href = 'ascenddb.php'>Sort in Ascending Order</a></p>";
 	echo "<p><a href = 'descenddb.php'>Sort in Descending Order</a></p>";
 }
 else
 {
...
<form action = "viewcommentdb.php" method = "post">
