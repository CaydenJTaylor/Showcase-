...
if($connect)
 {
 	...
 	if(mysqli_query($connect, "INSERT INTO comments(name,email,comments) VALUES ('Bobby','bobby.gmail.com','cowboys play thursday')"))
 	{
...
$sql = "INSERT INTO comments(name,email,comments) VALUES ('cayden','mail','comment')";
if(mysqli_query($connect,$sql))
{ echo "Added new ";}
else {
    echo "Error: " . $sql . "<br>" . mysqli_error($connect);
